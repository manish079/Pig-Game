let total_score, activePlayer, isPlaying, scores, prev_dice;

init();

document.querySelector(".m").style.color = "#eb4d4d";
...
document.querySelector(".btn-roll").addEventListener("click", () => {
  if (isPlaying) {
    ...
    //If 2 times 6 got back to back then set current player score is 0
    if (dice_num == 6 && prev_dice == 6) {
